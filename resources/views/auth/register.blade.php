<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input icon="fa-user" id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-text-input icon="fa-envelope" id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input icon="fa-lock" id="password_confirmation" class="block mt-1 w-full"
                            type="password"
