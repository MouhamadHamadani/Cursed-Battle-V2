<div>
    ...
    @if ($lastFight)
        @php
            ...
            // ponytail: re-keying on the result hash is what re-opens the modal
            // after it is dismissed — two byte-identical fights in a row would
            // not re-open it. Swap for a Livewire flag if that ever bites.
            $fightKey = substr(md5(json_encode($lastFight)), 0, 12);
        @endphp

        <div wire:key="fight-{{ $fightKey }}">
            <x-dark-modal show="true" maxWidth="5xl">
